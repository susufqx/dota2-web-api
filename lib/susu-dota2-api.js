...
/* get the history match of a player */
DotaTwoWebApi.prototype.getMatchHistory = function(options) {
  let path = 'IDOTA2Match_570/GetMatchHistory/v1';
  let keyOptions = 'account_id';

  return this._request(path, options, keyOptions);
}
/* todo get Heros list */
/* DotaTwoWebApi.prototype.getHeros = function(options) {}*/
/* todo get Items list */
/* DotaTwoWebApi.prototype.getGameItems = function(options) {}*/
